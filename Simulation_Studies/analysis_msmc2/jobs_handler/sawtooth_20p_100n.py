...
if len(sys.argv) == 1:
    ...
    datadir = f"{home_path}/labshare/gupadhya_folder/sims_final/sawtooth/"
    prefix = "20p_100n_"
    dataset = "sawtooth_dataset"
...
if len(sys.argv) > 1:
    ...
    inds_to_extract_from_vcf = 50*[True] + 50*[False]
    inds_to_analyze = indPair(100) # all pairs among the first 10
    ...
    changePoints = [50, 73, 107, 158, 232, 340, 500, 734, 1077, 1581, 2321, 3406, 5000, 7339, 10772, 15811, 23207, 34064, 50000]
