...
if len(sys.argv) > 1:
    ...
    binParameters = [2.30103,4.30103,.1111111111111111] # To use relate's default, specify -1 for third index ( [lb,ub,-1] ) then it ignores lb and rb and does default everything
