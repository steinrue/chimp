...
if len(sys.argv) > 1:
    ...
    binParameters = [1.60205999133,4.6021,0.16666666666666666] # To use relate's default, specify -1 for third index ( [lb,ub,-1] ) then it ignores lb and rb and does default everything
