...
if len(sys.argv) > 1:
    ...
    # effective size in haplotypes (not individuals)
    effectiveSize = 18850
    ...
    binParameters = [3.0,3.30103,.30103] # To use relate's default, specify -1 for third index ( [lb,ub,-1] ) then it ignores lb and rb and does default everything
