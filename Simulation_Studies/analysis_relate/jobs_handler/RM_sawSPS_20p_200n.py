...
if len(sys.argv) > 1:
    ...
    recoProb = 1.25e-8
    numLoci = 200e6
    num_inds = 100 #number of INDIVIDUALS, or haplotypes / 2
    ...
    binParameters = [1.60205999133,4.60205999136,0.16666666666666666] # To use relate's default, specify -1 for third index ( [lb,ub,-1] ) then it ignores lb and rb and does default everything
    ...
    os.system(mv_command)
    rm_command = f"rm {input_haps_file} {input_poplabels_file} {input_sample_file} {input_filtered_vcf}"
